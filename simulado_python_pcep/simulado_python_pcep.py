...
# build_date deve vir da hora de build/deploy, não do momento de execução.
# Prioriza a variável de ambiente BUILD_DATE, depois a data de modificação do arquivo.
...
if build_date_env:
    ...
    try:
        ...
        build_date = datetime.fromtimestamp(file_mtime, fuso_brasilia).strftime("%d/%m/%Y")
    except Exception:
        build_date = data_atual
...
st.markdown(
    ...
    <div class="rodape-container">
      <div class="rodape">
          ...
          <div class="links">
              <a href="https://github.com/Paulo-Carvalho1901" target="_blank">
          ...
          <div class="linha">⚙️ <b>Versão:</b> 3.0.2</div> 
          <div class="linha">🗓️ <b>Build:</b> {build_date}</div>        
      </div>
    </div>
    """,
    unsafe_allow_html=True
